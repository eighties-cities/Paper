---
title: "Companion Notebook for An agent-based model to investigate the effects of urban segregation around the clock on inequalities in health behaviour"
...
### Distribution of the synthetic population by demographic category in the Paris Region (night cells) (Figure 1)
...
## Sensitivity and robusness (figure 6)
...
## Proportions of agents with healthy behaviour for the 5 scenarios (figure 7)
...
#### Duncan Dissimilarity Index (figure 7)  
```{r, eval=F}
...
####  Moran's index of spatial autocorrelation (figure 7)
